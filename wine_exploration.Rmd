...
NN.quality = neuralnet(quality ~ ., training_set, hidden = 3 , linear.output = T)

# plot neural network
plot(NN.quality)

predict_test = compute(NN.quality, testing_set[,c(1:11)])
...
ggplot() +
  geom_boxplot(mapping = aes(testing_quality, predict_test))
               #col='blue', pch=16, ylab = "predicted rating NN", xlab = "real #rating")

#abline(0,1)

# Calculate Root Mean Square Error (RMSE)
RMSE = (sum((testing_set$quality - predict_test)^2) / nrow(testing_set)) ^ 0.5
RMSE
```
